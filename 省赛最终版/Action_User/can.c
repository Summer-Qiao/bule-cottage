...
static int16_t roll_vel_L=0, roll_vel_R=0;
void setrollvel_L(int16_t val)
{
  roll_vel_L = val;
}

int16_t getRollVel_L(void)//左滚轮速度
{
  return roll_vel_L;
}
...
int16_t getRollVel_R(void)//右滚轮速度
{
  return roll_vel_R;
}

static char color_l, color_r;
...
char getcollor_l(void)//右色标
{
  return color_l;
}

char getcollor_r(void)//左色标
{
  return color_r;
}
